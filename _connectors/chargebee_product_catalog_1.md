...
description: Supercharge your marketing automation with Chargebee Product Catalog 1.0 integration. Gain valuable insights from campaign data analysis.
...
sections:
  overview:
    ...
    description: Unlock advanced marketing data insights with Chargebee Product Catalog 1.0 integration. Optimize campaign strategies, analyze leads, and improve operational efficiency.
  ...
  faq:
    title: FAQs
    questions:
      - title: What are the most popular metrics in Chargebee Product Catalog 1.0 to analyze?
        bullets:
      ...
      - title: Why analyze Chargebee Product Catalog 1.0?
        bullets:
