...
description: Amplify your marketing data strategies with Chargebee Product Catalog 2.0 integration, gaining actionable insights from campaign data analysis.
...
sections:
  overview:
    ...
    description: Enhance your marketing data insights with Chargebee Product Catalog 2.0 integration. Seamlessly merge marketing data, unlocking insights that shape campaign strategies, lead analysis, and operational excellence.
  ...
  faq:
    title: FAQs
    questions:
      - title: What are the most popular metrics in Chargebee Product Catalog 2.0 to analyze?
        bullets:
