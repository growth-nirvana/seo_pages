...
sections:
  overview:
    ...
    description: Enhance your marketing automation insights with SAP Concur integration.
  ...
  body:
    title: Visualize Your SAP Concur channel data with Growth Nirvana's SAP Concur
      Connector
    description: Amplify your marketing automation strategies with SAP Concur integration,
      gaining actionable insights from campaign data analysis.
