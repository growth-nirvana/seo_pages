...
name: "Google Ads GCF"
description: Amplify your marketing strategies with Google Ads GCF integration, gaining actionable insights from campaign data analysis.
...
sections:
  overview:
    title: >-
      Google Ads GCF Data Connector
    description: Enhance your marketing insights with Google Ads GCF integration. Seamlessly merge marketing data, unlocking insights that shape campaign strategies, lead analysis, and operational excellence.
    image_url: /assets/images/seo_pages/body.webp

  body:
    title: >-
      Visualize Your Google Ads GCF channel data with Growth Nirvana's
      Google Ads GCF Connector
    description: Amplify your marketing strategies with Google Ads GCF integration, gaining actionable insights from campaign data analysis.
    image_url: /assets/images/seo_pages/body.webp
  faq:
    title: FAQs
      ...
      - title: What are the most popular metrics in Google Ads GCF to analyze?
        bullets:
          ...
          - title: Ad Performance
            description: Analyze ad campaign success rates, impressions, and click-through rates.
