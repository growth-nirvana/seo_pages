...
description: Amplify your marketing strategies with HubSpot integration, gaining actionable insights from data analysis.
...
sections:
  overview:
    ...
    description: Enhance your marketing insights with HubSpot integration. Seamlessly merge marketing data, unlocking insights that shape campaign strategies, lead analysis, and operational excellence.
  ...
  faq:
    title: FAQs
    questions:
      - title: What are the most popular metrics in HubSpot to analyze?
        bullets:
