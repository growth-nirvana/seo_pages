...
description: Amplify your marketing analytics strategies with NetSuite SuiteAnalytics integration, gaining actionable insights from campaign data analysis.
...
sections:
  overview:
    ...
    description: Enhance your marketing analytics with NetSuite SuiteAnalytics integration. Seamlessly merge marketing data, unlocking insights that shape campaign strategies, lead analysis, and operational excellence.
  ...
  faq:
    title: FAQs
    questions:
      - title: What are the most popular metrics in NetSuite SuiteAnalytics to analyze?
        bullets:
      ...
      - title: Why analyze NetSuite SuiteAnalytics?
        bullets:
