...
sections:
  overview:
    ...
    description: Enhance your marketing analytics with NetSuite SuiteAnalytics integration.
  ...
  body:
    title: Visualize Your NetSuite SuiteAnalytics channel data with Growth Nirvana's
