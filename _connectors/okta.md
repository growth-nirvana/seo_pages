...
name: "Okta"
description: Amplify your marketing automation strategies with Okta integration, gaining actionable insights from campaign data analysis.
...
sections:
  overview:
    title: >-
      Okta Data Connector
    description: Enhance your marketing automation insights with Okta integration. Seamlessly merge marketing data, unlocking insights that shape campaign strategies, lead analysis, and operational excellence.
  ...
  faq:
    title: FAQs
    questions:
      - title: What are the most popular metrics in Okta to analyze?
        bullets:
