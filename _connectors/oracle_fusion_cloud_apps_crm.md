...
description: Amplify your marketing strategies with Oracle Fusion Cloud Applications - CRM integration, gaining actionable insights from campaign data analysis.
...
sections:
  overview:
    ...
    description: Enhance your marketing insights with Oracle Fusion Cloud Applications - CRM integration. Seamlessly merge marketing data, unlocking insights that shape campaign strategies, lead analysis, and operational excellence.
  ...
  faq:
    title: FAQs
    questions:
      - title: What are the most popular metrics in Oracle Fusion Cloud Applications - CRM to analyze?
        bullets:
      ...
      - title: Why analyze Oracle Fusion Cloud Applications - CRM?
        bullets:
