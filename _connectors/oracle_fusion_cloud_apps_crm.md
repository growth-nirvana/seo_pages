...
description: Amplify your marketing strategies with Oracle Fusion Cloud Applications
  - CRM integration, gaining actionable insights from campaign data analysis.
...
usage: 0
schema_name: oracle_fusion_cloud_apps_crm
sections:
  overview:
    title: Oracle Fusion Cloud Applications - CRM Data Connector
    description: Enhance your marketing insights with Oracle Fusion Cloud Applications
      - CRM integration. Seamlessly merge marketing data, unlocking insights that
      shape campaign strategies, lead analysis, and operational excellence.
    image_url: "/assets/images/seo_pages/overview.webp"
  body:
    title: Visualize Your Oracle Fusion Cloud Applications - CRM channel data with
      Growth Nirvana's Oracle Fusion Cloud Applications - CRM Connector
    description: Amplify your marketing strategies with Oracle Fusion Cloud Applications
      - CRM integration, gaining actionable insights from campaign data analysis.
