...
name: "Pardot"
description: Amplify your marketing automation strategies with Pardot integration, gaining actionable insights from campaign data analysis.
...
sections:
  overview:
    ...
    description: Enhance your marketing automation insights with Pardot integration. Seamlessly merge marketing data, unlocking insights that shape campaign strategies, lead analysis, and operational excellence.
  ...
  faq:
    title: FAQs
    questions:
      - title: What are the most popular metrics in Pardot to analyze?
        bullets:
