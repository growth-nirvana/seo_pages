...
description: Amplify your marketing automation strategies with Salesforce Marketing Cloud integration, gaining actionable insights from campaign data analysis.
...
sections:
  overview:
    ...
    description: Enhance your marketing automation insights with Salesforce Marketing Cloud integration. Seamlessly merge marketing data, unlocking insights that shape campaign strategies, lead analysis, and operational excellence.
  ...
  faq:
    title: FAQs
    questions:
      - title: What are the most popular metrics in Salesforce Marketing Cloud to analyze?
        bullets:
      ...
      - title: Why analyze Salesforce Marketing Cloud?
        bullets:
