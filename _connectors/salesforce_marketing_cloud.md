...
sections:
  overview:
    ...
    description: Enhance your marketing automation insights with Salesforce Marketing
      Cloud integration. Seamlessly merge marketing data, unlocking insights that
      shape campaign strategies, lead analysis, and operational excellence.
    image_url: "/assets/images/seo_pages/overview.webp"
  body:
    title: Visualize Your Salesforce Marketing Cloud channel data with Growth Nirvana's
