...
description: Amplify your marketing strategies with Salesforce Sandbox integration, gaining actionable insights from data analysis.
...
sections:
  overview:
    ...
    description: Enhance your marketing insights with Salesforce Sandbox integration. Seamlessly merge marketing data, unlocking insights that shape campaign strategies, lead analysis, and operational excellence.
  ...
  faq:
    title: FAQs
    questions:
      - title: What are the most popular metrics in Salesforce Sandbox to analyze?
        bullets:
      ...
      - title: Why analyze Salesforce Sandbox?
        bullets:
