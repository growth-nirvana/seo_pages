...
description: Amplify your sales automation strategies with Salesloft integration, gaining actionable insights from campaign data analysis.
...
sections:
  overview:
    ...
    description: Enhance your sales automation insights with Salesloft integration. Seamlessly merge marketing data, unlocking insights that shape campaign strategies, lead analysis, and operational excellence.
  ...
  faq:
    title: FAQs
    questions:
      - title: What are the most popular metrics in Salesloft to analyze?
        bullets:
      ...
      - title: Why analyze Salesloft?
        bullets:
          - title: Enhance Campaign Strategies
            description: Refine sales campaigns based on data-driven insights.
          - title: Lead Analysis
