...
description: Amplify your marketing strategies with SAP Business ByDesign integration, gaining actionable insights from data analysis.
...
sections:
  overview:
    ...
    description: Enhance your marketing insights with SAP Business ByDesign integration. Seamlessly integrate marketing data, unlocking insights that shape campaign strategies, lead analysis, and operational excellence.
  ...
  faq:
    title: FAQs
    questions:
      - title: What are the most popular metrics in SAP Business ByDesign to analyze?
        bullets:
      ...
      - title: Why analyze SAP Business ByDesign?
        bullets:
