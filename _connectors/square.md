...
name: Square
description: Amplify your marketing strategies with Square integration, gaining actionable
...
sections:
  overview:
    title: Square Data Connector
    description: Enhance your marketing insights with Square integration. Seamlessly
      merge marketing data, unlocking insights that shape campaign strategies, lead
      analysis, and operational excellence.
    image_url: "/assets/images/seo_pages/overview.webp"
  body:
    title: Visualize Your Square channel data with Growth Nirvana's Square Connector
    description: Amplify your marketing strategies with Square integration, gaining
      actionable insights from data analysis.
    image_url: "/assets/images/seo_pages/body.webp"
  faq:
    title: FAQs
    questions:
    - title: What are the most popular metrics in Square to analyze?
      bullets:
