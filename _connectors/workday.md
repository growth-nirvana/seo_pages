...
name: "Workday RaaS"
description: Amplify your marketing automation strategies with Workday RaaS integration, gaining actionable insights from campaign data analysis.
...
sections:
  overview:
    ...
    description: Enhance your marketing automation insights with Workday RaaS integration. Seamlessly merge marketing data, unlocking insights that shape campaign strategies, lead analysis, and operational excellence.
  ...
  faq:
    title: FAQs
    questions:
      - title: What are the most popular metrics in Workday RaaS to analyze?
        bullets:
      ...
      - title: Why analyze Workday RaaS?
        bullets:
