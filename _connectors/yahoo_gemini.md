...
name: "Verizon Media"
description: Amplify your marketing strategies with Verizon Media integration, gaining actionable insights from campaign data analysis.
...
sections:
  overview:
    ...
    description: Unlock valuable marketing insights with Verizon Media integration, seamlessly merging marketing data to shape campaign strategies, lead analysis, and operational excellence.
  ...
  faq:
    title: FAQs
    questions:
      - title: What are the most popular metrics in Verizon Media to analyze?
        bullets:
      ...
      - title: Why analyze Verizon Media?
        bullets:
