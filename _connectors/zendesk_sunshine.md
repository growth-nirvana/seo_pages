...
description: Amplify your marketing strategies with Zendesk Sunshine integration, gaining actionable insights from campaign data analysis.
...
sections:
  overview:
    ...
    description: Enhance your marketing insights with Zendesk Sunshine integration. Seamlessly merge marketing data, unlocking insights that shape campaign strategies, lead analysis, and operational excellence.
  ...
  faq:
    title: FAQs
    questions:
      - title: What are the most popular metrics in Zendesk Sunshine to analyze?
        bullets:
      ...
      - title: Why analyze Zendesk Sunshine?
        bullets:
