...
sections:
  overview:
    ...
    description: Enhance your marketing insights with Zoho CRM integration. Seamlessly
      merge marketing data, unlocking insights that shape campaign strategies, lead
      analysis, and operational excellence.
    image_url: "/assets/images/seo_pages/overview.webp"
  body:
    title: Visualize Your Zoho CRM channel data with Growth Nirvana's Zoho CRM Connector
    description: Amplify your marketing strategies with Zoho CRM integration, gaining
      actionable insights from campaign data analysis.
