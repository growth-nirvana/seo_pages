...
name: "Zuora Sandbox"
description: Amplify your marketing data strategies with Zuora Sandbox integration, gaining actionable insights from data analysis.
...
sections:
  overview:
    ...
    description: Enhance your marketing data insights with Zuora Sandbox integration. Seamlessly merge marketing data, unlocking insights that shape campaign strategies, lead analysis, and operational excellence.
  ...
  faq:
    title: FAQs
    questions:
      - title: What are the most popular metrics in Zuora Sandbox to analyze?
        bullets:
      ...
      - title: Why analyze Zuora Sandbox?
        bullets:
