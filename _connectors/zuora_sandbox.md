...
sections:
  overview:
    ...
    description: Enhance your marketing data insights with Zuora Sandbox integration.
  ...
  body:
    title: Visualize Your Zuora Sandbox channel data with Growth Nirvana's Zuora Sandbox
      Connector
    description: Amplify your marketing data strategies with Zuora Sandbox integration,
      gaining actionable insights from data analysis.
